<?php
    ...
    $config['photo']['photo_static'][$nametype]['title_main'] = "Background dịch vụ";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    ...
    /* Background*/
    $nametype = "background-gioithieu";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Background Giới Thiệu";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['background'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 1366;
    $config['photo']['photo_static'][$nametype]['height'] = 350;
    ...
    /* Background*/
    $nametype = "background-thongtin";
    $config['photo']['photo_static'][$nametype]['title_main'] = "Background Thông Tin";
    $config['photo']['photo_static'][$nametype]['images'] = true;
    $config['photo']['photo_static'][$nametype]['background'] = true;
    $config['photo']['photo_static'][$nametype]['width'] = 1366;
    $config['photo']['photo_static'][$nametype]['height'] = 350;
